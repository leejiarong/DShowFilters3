...
const AMOVIESETUP_FILTER sudFilter[] = {
    {&__uuidof(CMpaSplitterFilter), MpaSplitterName, MERIT_UNLIKELY/*MERIT_NORMAL*/ + 1, _countof(sudpPins), sudpPins, CLSID_LegacyAmFilterCategory},
    {&__uuidof(CMpaSourceFilter), MpaSourceName, MERIT_UNLIKELY/*MERIT_NORMAL*/ + 1, 0, NULL, CLSID_LegacyAmFilterCategory},
};
