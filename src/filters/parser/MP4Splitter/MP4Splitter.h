...
#define MP4SplitterName L"Acer MP4 Splitter"
#define MP4SourceName   L"Acer MP4 Source"

//class __declspec(uuid("61F47056-E400-43d3-AF1E-AB7DFFD4C4AD"))
class __declspec(uuid("9C7FDFEB-8317-4949-A5F6-914D4C2A490A"))
...
class __declspec(uuid("4CF09C1E-6396-4df8-85AC-C7748D63FD75"))
