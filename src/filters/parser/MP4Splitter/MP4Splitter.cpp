...
const AMOVIESETUP_FILTER sudFilter[] = {//Metrit value must be greater than MpegAudioSplitter(MERIT_NORMAL+1), or some MOV will have no video stream
    {&__uuidof(CMP4SplitterFilter), MP4SplitterName, MERIT_NORMAL+2, _countof(sudpPins), sudpPins, CLSID_LegacyAmFilterCategory},
    {&__uuidof(CMP4SourceFilter), MP4SourceName, MERIT_NORMAL+2, 0, NULL, CLSID_LegacyAmFilterCategory},
